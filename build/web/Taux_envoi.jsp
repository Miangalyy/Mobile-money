<%-- 
    Document   : Taux_envoi
    Created on : 25 juin 2024, 16:41:03
    Author     : pc
--%>
...
<html>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="Taux_envoi.jsp">Taux d'envoi</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-sm-3">
                <div class="container">
                    <form action="action" name="frmStudent" id="frmStudent">
                        ...
                        <br>
                        <div class="form-group form-floating mb-3">
                            <input type="number" id="frais_env" name="frais_env" placeholder="Frais" size="30px" class="form-control" required />
                            <label for="frais_env">Frais envoi </label>
                        </div>
                        <br>
    ...
    <script>
            ...
            function addClient () {
                ...
                var method;
                if (isNew === true) {
                    url = "Controller/Taux_envoi/Insert.jsp";
                    data = $("#frmStudent").serialize();
                    method = 'POST';
                }
                else {
                    url = "Controller/Taux_envoi/Update.jsp";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        Swal.fire({
                           ...
                           position: 'top-end',
                           icon: 'success',
                           title: "Taux d'envoi enregistrer dans la BD :)",
            ...
            function getall () {
                ...
                $.ajax({
                    url: "Controller/Taux_envoi/Select.jsp",
                    type: "GET",
                    dataType: "JSON",
                        ...
                        $('#tbl-student').dataTable({
                           ...
                           },
                           {
                               ...
                               "sTitle":"montant2(Ar)","mData":"montant2"
                                                      ...
                                                      {
                               "sTitle":"Frais(Ar)","mData":"frais_env"
                           },
            ...
            function get_details (id) {
                $.ajax({
                    type: "POST",
                    url: "Controller/Taux_envoi/Edit.jsp",
                    data: {"id": id},
            ...
            function get_delete (id) {
                $.ajax({
                    type: 'POST',
                    url: 'Controller/Taux_envoi/Delete.jsp',
                    dataType: 'JSON',
                    data: {"id": id},
                    ...
                    success: function (data) {
                        Swal.fire({
                           ...
                           position: 'top-end',
                           icon: 'success',
                           title: "Taux d'envoi supprimer dans la BD :)",
                           showConfirmButton: false,
                           timerProgressBar: true,
                           timer: 2300
                         });
